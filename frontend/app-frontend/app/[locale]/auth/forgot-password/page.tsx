      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
              ...
              <form onSubmit={handleRequestReset} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  />
                </div>
          ...
          {step === 'sent' && (
            <>
              ...
              <button
                ...
                className="w-full py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 transition-colors"
              >
                {t('useOtherEmail')}
              </button>
            </>
          ...
          {step === 'reset' && (
            <>
              <div className="text-center mb-6">
                <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">{t('newPasswordTitle')}</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t('newPasswordSubtitle')}</p>
              </div>
          ...
          {step === 'done' && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">{t('doneDesc')}</p>
              <Link
                href="/auth/login"
