      ...
      <div className="hidden lg:block relative w-0 flex-1">
        <div className="absolute inset-0 bg-linear-to-br from-primary-500 via-primary-600 to-primary-700 flex flex-col justify-center items-center p-12">
          <div className="max-w-md text-center text-white">
            {/* Badge */}
            <div className="inline-flex items-center px-3 py-1.5 bg-white dark:bg-gray-900/20 rounded-full text-sm font-medium mb-4">
            ...
            {/* Testimonial */}
            <div className="bg-white dark:bg-gray-900/10 rounded-xl p-4 mb-4">
