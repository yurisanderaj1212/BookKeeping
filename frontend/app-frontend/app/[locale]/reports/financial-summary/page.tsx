            ...
            <div className="flex items-center justify-between min-h-16 py-3 gap-3">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  <h1 className="text-base sm:text-xl font-bold text-gray-900 dark:text-gray-100 truncate">{tReport('financialSummary')}</h1>
                  <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">{tReport('financialSummaryDesc')}</p>
                </div>
              </div>
