...
export default function TransactionDetailPage() {
  ...
  const handleExport = () => {
    showExportModal((format) => {
      exportReportData('transaction-detail', format)
    })
  }
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Detalle de Transacciones</h1>
                  <p className="text-sm text-gray-500 mt-1">Registro completo de transacciones</p>
                </div>
              </div>
