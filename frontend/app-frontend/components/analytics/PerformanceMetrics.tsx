    ...
    <div className="space-y-6 mb-8">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t('performanceTitle')}</h3>
            ...
            {performanceData.map((metric, i) => (
              <div key={i} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">{metric.metric}</h4>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold text-gray-900 dark:text-gray-100">{metric.value.toFixed(1)}{metric.unit}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-500 dark:text-gray-400">{t('target')}</span>
                    <span className="text-sm text-gray-600 dark:text-gray-400">{metric.target}{metric.unit}</span>
                  </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            <div className="bg-linear-to-r from-blue-50 to-purple-50 rounded-lg p-4">
              ...
              <div className="w-full bg-white dark:bg-gray-900 rounded-full h-2">
